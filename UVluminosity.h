...
void writeUVLF(cosmology &C, double Mm, double Mt, double Mc, double epsilon2, double epsilon3, double alpha, double beta, double gamma, double kappa3, double sigmaUV, double logm, int dm);
